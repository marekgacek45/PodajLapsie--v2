<x-layouts.app title="Podaj Łapsie -  Skontaktuj się ze mną | Behawiorysta i Szkolenie Psów w Nowym Targu i na Podhalu" description='Jeśli masz pytania lub chcesz umówić się na konsultacje behawiorystyczne, szkolenie psa lub petsitting, skontaktuj się ze mną. Jako doświadczony behawiorysta i trener psów w Nowym Targu oferuję profesjonalną pomoc. Czekam na Twój kontakt!'>
      <main class="pt-10 ">
  
        <x-section class="bg2 bg-gray-800">
            <x-wrapper  id="kontakt" :title="'Skontaktuj się ze mną'" class=" min-w-full  py-24 mb-0">
